var CrowdFundingApp = angular.module('app', ['ngMaterial', 'ngDisqus', 'ui.router', 'ui.bootstrap', 'ngAnimate', 'ngDialog', 'angular-loading-bar', 'Services', 'LocalStorageModule', 'swipe', 'angular-carousel-3d', 'ngAnimate', 'base64']);
